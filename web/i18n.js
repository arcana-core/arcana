...
(function(){
  ...
  const dict = {
    'en': {
      ...
      'skills.hint.skills': 'Unchecked = disable the skill',
      'skills.hint.tools': 'Unchecked = disable the tool',
      'skills.noneFound': 'No skills found',
      'skills.loadFailed': 'Failed to load skills list',
      'skills.tools.noneFound': 'No tools found',
      'skills.tools.loadFailed': 'Failed to load tools list',
    ...
    'zh-CN': {
      ...
      'skills.tab.tools': '工具',
      'skills.hint.skills': '取消勾选=禁用该技能',
      'skills.hint.tools': '取消勾选=禁用该工具',
      'skills.noneFound': '未发现技能',
      'skills.loadFailed': '技能列表加载失败',
      'skills.tools.noneFound': '未发现工具',
      'skills.tools.loadFailed': '工具列表加载失败',
