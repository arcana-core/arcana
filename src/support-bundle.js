...
function envSummary(){
  const out = {};
  const keep = ['ARCANA_WORKSPACE','ARCANA_PROVIDER','ARCANA_MODEL','ARCANA_THINKING','ARCANA_EXEC_POLICY','ARCANA_PW_ENGINE','ARCANA_MEMORY_TRIGGERS','ARCANA_SOP_EXTRACTION','OPENAI_BASE_URL','OPENAI_API_BASE'];
